...
{
    public class AudioManger : NormalSingleton<AudioManger>
    {
        AudioSource AS_UI;
        AudioSource AS_BGM;
        ...
        private AudioManger()
        {
            ...
            if (!audioObject)
                audioObject = new GameObject("AudioManger");

            //BGM
            bgmObject = new GameObject("BgmSound");
            bgmObject.transform.parent = audioObject.transform;
            ...
            //UI
            uiObject = new GameObject("UISound");
            uiObject.transform.parent = audioObject.transform;
            ...
            //Effect
            effectObject = new GameObject("UIEffect");
            effectObject.transform.parent = audioObject.transform;
        ...
        public AudioSource CreateNewUISource()
        {
        ...
        public AudioSource CreateNewEffectSource()
        {
        ...
        public void SetAudioSourceVolume(AudioType type,float volume)
        {
            if(type==AudioType.BGM)
            {
        ...
        public void OnPlayUIButtonSound(UI_SoundType type)
        {
            ...
            if (clip != null)
                PlayAudioClip(AudioType.UI, clip);
        }
